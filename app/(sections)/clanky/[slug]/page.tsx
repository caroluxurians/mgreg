      ...
      <main className="text-medium-pink mt-4 sm:mt-6">
        ...
        <div className="flex flex-col main-width mx-auto mb-10 sm:mb-12 md:mb-16 2xl:mb-20 3xl:mb-26">
          <div className="flex flex-col gap-1 border-b border-light-pink pb-4 mb-3 sm:pb-5 lg:mb-5 lg:mt-5 lg:gap-2 2xl:gap-3 2xl:mb-6 2xl:pb-8">
            <Link
              href="/clanky"
              className="bg-medium-pink rounded-full text-sm text-white font-semibold italic text-center w-fit h-fit px-4 py-1 mr-6 md:text-base lg:text-lg 2xl:text-xl 3xl:px-7 3xl:py-2.5"
            >
              zpět na články
            </Link>
          ...
          <h1 className="font-heading text-4xl mb-3 sm:text-5xl sm:w-130 sm:mx-auto md:text-6xl md:w-162 md:mb-4 lg:text-7xl lg:w-196 2xl:text-8xl 2xl:w-270 3xl:text-9xl 3xl:w-350 3xl:mb-8">
            {article.title}
          </h1>
