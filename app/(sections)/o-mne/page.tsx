        ...
        >
          ...
          >
            <div className="pt-10 pb-12 grid grid-cols-2 relative">
              ...
              justify-between sm:h-576 sm:top-12 sm:left-6 sm:pb-40 md:left-2 lg:h-310 lg:left-0 3xl:h-340 3xl:top-16"
              >
            ...
            <div className="flex flex-col h-550 justify-between mt-12 sm:h-590 sm:mt-14 md:ml-5 lg:h-370 lg:pt-6 lg:pb-22 2xl:ml-8 3xl:h-400 3xl:ml-9 3xl:pt-9">
              <TimelineEvent
