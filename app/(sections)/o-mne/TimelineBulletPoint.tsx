...
const TimelineBulletPoint = ({ shape, styles = "", year = "2018" }: TimelineBulletPointProps) => {
  return (
    <div className={classNames(`flex items-center h-20 ${styles} relative`)}>
      ...
      <div className="absolute left-14 z-0 w-8 h-1 bg-red-pink sm:w-10 sm:left-16 md:w-12 md:left-18 lg:w-14 lg:left-24 xl:w-14 xl:left-30 2xl:w-16 2xl:left-36 3xl:w-19 3xl:left-43" />
    </div>
  );
};
