const PressRelease = ({ index }: { index: number }) => {
  return (
    <div className="flex items-center border-b border-red-pink justify-between md:pl-2 md:pb-4 xl:h-38">
      ...
      <div className="text-[14px] font-bold w-80 sm:text-[18px] md:text-[16px] xl:text-[18px] xl:w-90 2xl:text-[24px]/[34px] 2xl:w-110">
        „Pravda bolí“ – startuje kampaň europoslankyně Gregorové věnovaná dezinformacím
      </div>
      <div className="flex flex-col text-[12px] italic w-25 items-end gap-2 sm:text-[16px] pr-1 md:hidden lg:flex lg:pt-3 lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 2xl:mb-6 2xl:gap-3">
